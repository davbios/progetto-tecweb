...
class Step extends BaseModel
{
    ...
    public function __construct(int $number, string $description, ?int $id, ?DateTime $created_at, ?DateTime $updated_at)
    {
...
interface StepDao
{
    ...
    public function insert(Step $step, int $drinkId): Step;
    public function update(Step $step, int $drinkId): Step;
...
class PdoStepDao implements StepDao
{
    ...
    public function getAllForDrink(int $drinkId): array
    {
        $stmt = $this->pdo->prepare("SELECT id, num, description, created_at, updated_at FROM steps 
    ...
    public function findById(int $id): ?Step
    {
        $stmt = $this->pdo->prepare("SELECT id, num, description, created_at, updated_at FROM steps WHERE id = :id");
